    ...
    >
      {imageUrl ? (
        <div className="relative h-52 w-full overflow-hidden">
          ...
          <div
            className={
              "absolute inset-0 bg-gradient-to-t to-transparent opacity-60 group-hover:opacity-70 transition-opacity " +
              (isDark ? "from-black/60 via-black/20" : "from-black/50 via-black/10")
            }
          />
        </div>
      ) : (
        <div
          className={
            ...
            (isDark
              ? "bg-gradient-to-br from-[#e14242]/30 via-[#1a1a1a] to-[#141414]"
              : "bg-gradient-to-br from-red-50 via-white to-zinc-100")
          }
        >
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <h3
          className={
            "mt-2 line-clamp-2 text-lg font-semibold transition-colors " +
        ...
        {summary && (
          <p className={"mt-2 line-clamp-3 text-sm " + (isDark ? "text-zinc-300/80" : "text-zinc-600")}>
            {summary}
          </p>
        )}
      </div>
