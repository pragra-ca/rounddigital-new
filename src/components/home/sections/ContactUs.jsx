    ...
    <div className="w-full py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-block bg-[#e14242] rounded-[7px] px-3 py-1 mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl h-full">
            ...
            <p className="text-gray-600 mb-8">
              Feel free to reach out to us using the contact information below or send us a message using the form.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">123 Business Ave, Suite 100<br />New York, NY 10001</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-gray-600">info@rounddigital.com</p>
                </div>
              </div>
