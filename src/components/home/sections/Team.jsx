...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      name: "Renu Singh",
      role: "HR Head",
      description: "Drives talent acquisition and organizational development, building high-performing teams and fostering a positive workplace culture.",
      image: "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Renu_Singh.jpg",
      social: { linkedin: "https://www.linkedin.com/in/renussingh/" },
    },
    {
      id: 3,
      name: "Neha Gaur",
      role: "AI Engineer",
      description: "Develops cutting-edge AI solutions and machine learning models to drive intelligent automation and business innovation.",
      image: "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Neha_Gaur.jpg",
      social: { linkedin: "https://www.linkedin.com/in/nehagaur1/" },
    },
    {
      id: 4,
      name: "Himanshu Kansal",
      role: "Software Engineer",
      description: "Builds robust and scalable software solutions, leveraging modern technologies to deliver high-quality applications.",
      image: "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Himanshu_Kansal.jpg",
      social: { linkedin: "https://www.linkedin.com/in/hkansal27/" },
    },
    {
      id: 5,
      name: "Rahul Singh",
