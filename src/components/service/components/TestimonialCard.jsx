...
const testimonials = [
    {
        ...
        text: `I recently hired <strong>Ideapeel</strong> for a custom web development project<br />and couldn't be happier with the results.`,
        name: 'Sumit Kumar',
    ...
    },
    {
        ...
        text: `Our collaboration with <strong>Ideapeel</strong> was a game-changer.<br />Their professionalism and attention to detail gave our brand a huge boost.`,
        name: 'Mark Henderson',
