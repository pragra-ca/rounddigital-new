...
function TeamSection() {
  const teamMembers = [
    ...
    },
    {
      ...
      role: "HR Head",
      position: "HR",
      description: "Drives talent acquisition and organizational development, building high-performing teams.",
      image:
        "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Renu_Singh.jpg",
      badgeColor: "bg-red-600",
      textColor: "text-white",
      borderColor: "border-white/80",
    },
    {
      ...
      role: "AI Engineer",
      position: "AI",
      description: "Develops cutting-edge AI solutions and machine learning models for intelligent automation.",
      image:
        "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Neha_Gaur.jpg",
      badgeColor: "bg-red-600",
      textColor: "text-white",
      borderColor: "border-white/80",
    },
    {
      ...
      position: "SDE",
      description: "Builds robust and scalable software solutions using modern technologies.",
      image:
        "https://res.cloudinary.com/dm1txojyd/image/upload/v1736773360/Himanshu_Kansal.jpg",
      badgeColor: "bg-red-600",
      textColor: "text-white",
      borderColor: "border-white/80",
    },
