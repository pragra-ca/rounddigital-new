  ...
  const timeline = [
    {
      year: '2015',
      title: 'Foundation',
      description: 'Started with vision to digital transformation of business',
    },
    {
      year: '2017',
      title: 'Digital First Initiative',
      description: 'Supported Digital Adoption initiative to help businesses embrace digital transformation',
    },
    {
      year: '2020',
      title: 'Innovation and Digital Shop',
      description: 'To mitigate challenges by Covid',
    },
    {
      year: '2023',
      title: 'AI First Approach',
      description: 'Solve critical problems leveraging AI',
    },
  ];
