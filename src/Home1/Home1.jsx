...
export const HomeComponent = () => {
  return (
    ...
    <div className="bg-white w-[1440px] relative">
      ...
      <div className="flex flex-col w-full items-start gap-8 md:gap-16 lg:gap-[70px] absolute top-[30px] md:top-[45px] lg:top-[60px] left-0 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[100px]">
      

        <header className="flex flex-col lg:flex-row w-full items-start lg:items-center justify-between gap-8 lg:gap-0 py-0 relative bg-transparent">
          ...
          <div className="relative w-full max-w-[600px] h-[400px] sm:h-[450px] lg:h-[515px] mt-8 lg:mt-0 mx-auto lg:mx-0">
            <div className="relative w-[600px] h-[515px]">
              <img
                className="absolute w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 top-[330px] sm:top-[380px] lg:top-[427px] left-1/2 lg:left-[293px] transform -translate-x-1/2 lg:translate-x-0"
                alt="Frame"
                src={frame}
              />
              ...
              <div className="absolute w-[600px] h-[515px] top-0 left-0">
                <img
                  className="absolute w-[70px] h-[70px] sm:w-[85px] sm:h-[85px] lg:w-[99px] lg:h-[99px] top-[240px] sm:top-[280px] lg:top-[313px] left-4 sm:left-8 lg:left-[58px]"
                  alt="Frame"
                  src={frame2}
                />
              ...
              <div className="absolute w-4 h-4 sm:w-[18px] sm:h-[18px] lg:w-5 lg:h-5 top-[330px] sm:top-[380px] lg:top-[425px] left-[85%] sm:left-[400px] lg:left-[411px] bg-[#ff8181] rounded-full" />
        ...
        <div className="flex w-[1440px] items-start justify-between px-[100px] py-0 relative flex-[0_0_auto]">
          <img
            className="relative w-[124.11px] h-12"
            alt="Company logo"
            src={companyLogo6}
          />

          <img
            className="w-[126.37px] relative h-12"
            alt="Company logo"
            src={companyLogo}
          />

          <img
            className="w-[128.63px] relative h-12"
            alt="Company logo"
            src={companyLogo5}
          />

          <img
            className="w-[145.55px] relative h-12"
            alt="Company logo"
            src={companyLogo2}
          />

          <img
            className="w-[125.24px] relative h-12"
            alt="Company logo"
            src={companyLogo4}
          />

          <img
            className="w-[110.57px] relative h-12"
            alt="Company logo"
            src={companyLogo3}
          />
        </div>
