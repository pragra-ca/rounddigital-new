...
export const rdServices = {
  ...
  "global-talent": {
    id: "global-talent",
    tag: "Any role, any industry",
    title: "Global Talent Sourcing",
    headline: "The people you can't hire, sourced worldwide.",
    desc: "Technology, professional, healthcare and skilled workforce talent — sourced, vetted and mobilized from our global network, embedded in your team within weeks.",
    cta: "Tell us your roles",
    statsLabel: "OUR NETWORK, BY THE NUMBERS",
    stats: [
      { n: "3", l: "global sourcing hubs" },
      { n: "12", l: "industries served" },
      { n: "24/7", l: "follow-the-sun coverage" },
      { n: "2wk", l: "typical time to embed" },
    ],
    builds: [
      { t: "Technology & engineering", d: "Senior engineers, cloud architects and AI specialists for the roles that stay open longest." },
      { t: "Professional & corporate", d: "Finance, HR, marketing, sales, operations and administration — vetted for the function, not just the résumé." },
      { t: "Healthcare & skilled trades", d: "Nurses, allied health, technicians and licensed trades, screened against the credentials your regulator requires." },
      { t: "Managed back-office teams", d: "Support, accounting, claims and data operations pods, run to your SLAs from our delivery hubs." },
    ],
    stack: ["Toronto", "Dallas", "Pune", "Credential screening", "Visa & relocation", "Your rhythm"],
    faqs: [
      { q: "Do you only source technical roles?", a: "No. Engineering is where we started and where our own delivery bench sits, but the sourcing practice spans professional and corporate functions, healthcare and skilled trades, and fully managed back-office teams across twelve industries." },
      { q: "How is talent vetted?", a: "Every candidate goes through multi-stage screening against the role: technical assessment and a paid trial for engineering, competency and function-specific testing for professional roles, and licence, credential and right-to-work verification for healthcare and trades." },
      { q: "Can you handle visas and relocation?", a: "Yes. For cross-border placements we manage credential recognition, immigration paperwork and relocation logistics alongside your legal team, and we won't present a candidate whose pathway we haven't already checked." },
      { q: "What if it isn't working out?", a: "Two-week replacement guarantee, no questions asked. Continuity is our problem, not yours." },
      { q: "Do they work our hours?", a: "Toronto and Dallas placements work your timezone; Pune extends you to follow-the-sun coverage if you want it." },
    ],
    outroTitle: "Need people fast?",
    outroBody: "Tell us the roles — technical or not. We'll show you profiles this week and embed the team within two.",
    seo: {
      title: "Global Talent Sourcing & Staffing Across Industries",
      description: "Vetted technology, professional, healthcare and skilled-trades talent sourced worldwide and embedded in your team within two weeks — plus managed back-office pods.",
      keywords: "global talent sourcing, international recruitment, IT staff augmentation, healthcare staffing, skilled trades recruitment, offshore back office teams, managed delivery pods",
    },
  },
  "engagement-models": {
...
const RD_SERVICE_CONTENT = {
  ...
  "global-talent": {
    overview: {
      heading: "The roles you can't fill, sourced and embedded",
      paragraphs: [
        "Hiring is slow, expensive and — for the roles that decide whether a plan happens — often impossible on the timeline you actually have. That's as true of a ward short of nurses or a site short of licensed trades as it is of an AI team short of engineers. We source from our Toronto, Dallas and Pune network across four families of talent: technology and engineering, professional and corporate functions, healthcare and skilled trades, and fully managed back-office teams.",
        "These aren't résumés off a bench you'll never meet. Every candidate is screened against the role rather than a generic filter — technical assessment and a paid trial for engineers, competency testing for professional hires, and licence, credential and right-to-work verification for healthcare and trades. Where a placement crosses a border, we handle credential recognition, immigration and relocation before we ever put the profile in front of you.",
        "Need a team rather than individuals? We stand up dedicated pods with a lead and a single point of accountability — an engineering squad in your codebase, or a support, claims or accounting function running to your SLAs from our hubs. The engineering practice is what we're known for; it's also why our sourcing is run by people who have actually managed the work.",
      ],
    },
    outcomes: [
      { t: "Embedded in weeks, not months", d: "Typically two weeks from brief to people working — technical roles or not." },
      { t: "Screened for the role", d: "Technical trials, competency testing or licence and credential checks, matched to what the job actually requires." },
      { t: "Cross-border, handled", d: "Credential recognition, visa pathways and relocation managed before a profile reaches you." },
