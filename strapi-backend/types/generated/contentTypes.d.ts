...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company partners and logos';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'IT Services offered by the company';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    badgeBg: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'bg-[#e14242]'>;
    badgeText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'text-white'>;
    bgColor: Schema.Attribute.String & Schema.Attribute.DefaultTo<'bg-white'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
